PROMPTS = {
  "ABAP Dictionary": (
    ...
    "BW4Cockpit (Stammdaten)": (
        ...
        "      - Set 'LongTextConsistentStructure': true if ANY row contains the following substrings 'BAU - Bauwesen ' and/or. 'GES - Gesundheit ' and/or 'MuK - Management'\n"
        ...
        "{\n"
        "  \"CleanedColumns\": [\"Date to\", \"Department\", \"Long text\"],\n"
        "  \"HasLongTextColumn\": true,\n"
  ...
  "Datenvorschau": (
    ...
    "Transformation": (
        ...
        "4. NORMALIZE names of Source and Target. Convert all into lower case. if they contain the following Substrings by applying FIRST matching rule:\n"
        "   'bereich' or 'depart'→'Fachbereich', 'bache' or 'anzahlbach'→'Bachelorarbeiten'\n"
        "   'promo' or 'anzahlpro'→'Promotionen', 'stud' or 'anzahlstud'→'Studierenden'\n"
        "   'dritt' or 'exter'→'Drittmittel', 'landes'→'Landesmittel'\n"
        "   'semes'→'Semester', 'bund'or 'stat'→'Bundesland'\n"
